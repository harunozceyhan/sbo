...
public class OperationController {
    ...
    public ResponseEntity<PagedModel<?>> get(@Param("adi") String adi, @Param("kodu") String kodu,
        ...
        Page<Operation> operation = operationService.getOperationList(adi, kodu, startOperationDate, endOperationDate,
                p);
        return ResponseEntity.ok(operation.isEmpty() ? pagedResourcesAssembler.toEmptyModel(operation, Operation.class)
                : pagedResourcesAssembler.toModel(operation));
    }
}